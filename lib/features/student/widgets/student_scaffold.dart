  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: StudentScaffold._surface,
        border: const Border(
...
class _NavTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      splashColor: StudentScaffold._primary.withOpacity(0.08),
      highlightColor: StudentScaffold._primary.withOpacity(0.04),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: selected ? StudentScaffold._indicatorFill : Colors.transparent,
                borderRadius: BorderRadius.circular(20),
              ),
              child: Icon(
                selected ? item.activeIcon : item.icon,
                size: 22,
                color: selected ? StudentScaffold._primary : StudentScaffold._unselected,
              ),
            ),
